...
public class DiabloMotion : MonoBehaviour
{
    ...
    protected void Walk(Animator Anim, Vector2 playerPos, float Angle)
    {
        ...
        this.transform.position = Vector2.MoveTowards(transform.position, playerPos, WalkSpeed * Time.deltaTime);
    }
    ...
    protected void Run(Animator Anim, Vector2 playerPos, float Angle)
    {
        ...
        this.transform.position = Vector2.MoveTowards(transform.position, playerPos, RunSpeed * Time.deltaTime);
    }
