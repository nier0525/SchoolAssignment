...
public class SkullShadowMotion : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ani.SetFloat("Angle", demon.GetComponent<SkullMotion>().Angle);
    ...
    {
        if (!demon.GetComponent<SkullMotion>().isAtt)
        {
    ...
    public void Dead()
    {
        if (demon.GetComponent<SkullAI>().death)
        {
