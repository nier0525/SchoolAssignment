...
public class HepstoShadowMotion : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ani.SetFloat("Angle", demon.GetComponent<HepstoMotion>().Angle);
        ...
        if (!demon.GetComponent<HepstoMotion>().isAtt)
        {
    ...
    public void Dead()
    {
        if (demon.GetComponent<HepstoAI>().death)
        {
