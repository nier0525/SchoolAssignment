...
LPDIRECT3DTEXTURE9      g_pTexture2[3];
...
HRESULT InitGeometry()
{
    ...
    {
        { D3DXVECTOR3(-1.f, 1.f, 0.f), 0xffffffff, 0.f, 0.f },
        { D3DXVECTOR3(1.f, 1.f, 0.f), 0xffffffff, 1.f, 0.f },
        { D3DXVECTOR3(-1.f, -1.f, 0.f), 0xffffffff, 0.f, 1.f },
        { D3DXVECTOR3(1.f, -1.f, 0.f), 0xffffffff, 1.f, 1.f }
    };
    ...
    if (FAILED(D3DXCreateTextureFromFile(g_pd3dDevice, L"1.png", &g_pTexture2[index++])))
    {
        return E_FAIL;
    }
    if (FAILED(D3DXCreateTextureFromFile(g_pd3dDevice, L"2.png", &g_pTexture2[index++])))
    {
        return E_FAIL;
    } if (FAILED(D3DXCreateTextureFromFile(g_pd3dDevice, L"3.png", &g_pTexture2[index++])))
    {
        return E_FAIL;
    }
    index = 0;
...
VOID Render()
{
    ...
    // in the 0 to 1 range.
        ...
        g_pd3dDevice->SetTexture(0, g_pTexture2[index]);
        g_pd3dDevice->DrawPrimitive(D3DPT_TRIANGLESTRIP, 0, 1);

        g_pd3dDevice->SetTexture(0, g_pTexture2[index2]);
        g_pd3dDevice->DrawPrimitive(D3DPT_TRIANGLESTRIP, 1, 1);
